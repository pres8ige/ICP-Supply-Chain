...
import { idlFactory } from './supply_chain_backend.did.js';
export { idlFactory } from './supply_chain_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SUPPLY_CHAIN_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./supply_chain_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the supply_chain_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./supply_chain_backend.did.js")._SERVICE>}
 */
export const supply_chain_backend = createActor(canisterId);
